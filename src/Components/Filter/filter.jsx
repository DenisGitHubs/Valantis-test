  ...
  return (
    ...
    <div className="filter-menu">
      ...
      <ul className="filters">
        <li onClick={() => handleChange('product')} className={filter === 'product' ? 'selected' : ''}>Название</li>
        <li onClick={() => handleChange('price')} className={filter === 'price' ? 'selected' : ''}>Цена</li>
        <li onClick={() => handleChange('brand')} className={filter === 'brand' ? 'selected' : ''}>Бренд</li>
      </ul>
      <input
        type="text"
        value={inputValue}
    ...
    {showWarning === true ? <p className='empty-field'>Введите данные для поиска</p> : null}
    </>
  );
};
